...
namespace Business.Concrete
{
    public class UserOperationClaimManager : IUserOperationClaimService
    {
        ...
        public async Task<IDataResult<UserOperationClaim>> GetById(string id)
        {
        ...
        public async Task<IResult> Update(UserOperationClaim userOperationClaim)
        {
            ...
            return new SuccessResult(CoreAspectMessages.UserOperationClaimUpdated);
        }
        ...
        public async Task<IResult> Delete(UserOperationClaim userOperationClaim)
        {
            ...
            return new SuccessResult(CoreAspectMessages.UserOperationClaimDeleted);
        }
    }
}